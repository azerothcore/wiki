...
| CONDITION_SOURCE_TYPE_OBJECT_VISIBILITY           | 30  | 0 = Creature, 1 = GameObject                                                              | Entry                                                                               | 0 or the GUID of Creature/GameObject                               | Always 0                                                                                                                     | If SourceId (GUID) is set for an entry, only conditions for that GUID are checked |
