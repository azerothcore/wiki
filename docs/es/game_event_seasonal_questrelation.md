...
**Tabla \`game\_event\_seasonal\_questrelation\`**

Contiene información sobre las relaciones de quests estacionales de los eventos de juego para permitir el reinicio de quests con ZoneOrSort de -22.

**Estructura**

| Field           | Type      | Attributes | Key | Null | Default | Extra | Comment                 |
| --------------- | --------- | ---------- | --- | ---- | ------- | ----- | ----------------------- |
| [questId][1]    | INT       | UNSIGNED   | PRI | NO   | 0       |       | Identificador de la quest |
| [eventEntry][2] | MEDIUMINT | UNSIGNED   | PRI | NO   | 0       |       | Entry del evento de juego |
...
<summary>Haz click para ver el contenido de la tabla (29/09/2024)</summary>

| questId | eventEntry | Comment (no forma parte de la BD) |
|---------|------------|:------------------------------|
