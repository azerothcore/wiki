...
**Tabla \`spell\_custom\_attr\`**

Tabla usada para almacenar atributos de hechizo personalizados.
...
ID del hechizo. Ver [Spell.dbc](spell_dbc) .

### attributes

Atributos de hechizo personalizados de la enumeración SpellCustomAttributes en SpellInfo.h
...
| SPELL_ATTR0_CU_SHARE_DAMAGE                  | 8          | 0x00000008 | Hechizos tipo meteoro (daño dividido entre todos los objetivos)       |
...
| SPELL_ATTR0_CU_SINGLE_AURA_STACK             | 4194304    | 0x00400000 | Todas las fuentes añaden acumulaciones a la misma aura               |
...
| SPELL_ATTR0_CU_ONLY_ONE_AREA_AURA            | 536870912  | 0x20000000 | Solo 1 aura de área persistente puede estar activa (p. ej. el coldflame de Marrowgar) |
