...
- `CanAddMember`, `OnAddMember`, `OnGetPoints`: hooks de `ArenaScript` específicamente para validación de membresía de `ArenaTeam`, manejo posterior a añadir un miembro y cálculo de puntos.
