...
**Tabla \`npc\_text\_locale\`**

Esta tabla se usa para proporcionar a los clientes localizados cadenas localizadas para los npc\_texts.
...
Este id debe ser el mismo que [npc\_text.ID](npc_text#id) y entonces la fila se usará para proporcionar soporte de localización para este registro de npc\_text.
