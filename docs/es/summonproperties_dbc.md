...
Este DBC contiene las Summon Properties (EffectMiscValueB) para el Spell Effect SPELL_EFFECT_SUMMON (28)
...
Este es el ID de SummonProperties.dbc.
...
También conocido como tipo de invocación (summon type).
