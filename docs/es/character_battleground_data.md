...
Este es el instanceId del campo de batalla. Se comparte con [instance.id](instance#id), pero en lugar de poner los datos en esa tabla, están aquí.
...
Nodo de taxi de destino del personaje antes de unirse a un campo de batalla.

### mountSpell

El ID del hechizo de montura. Véase Spell.dbc columna 1
