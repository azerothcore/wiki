...
1. Haz click en **File** -> **Clone repository...** en la esquina superior izquierda
...
Haz click en **Clone**. En pocos minutos, los archivos fuente de Azerothcore se clonarán en **C:\Azerothcore**.
...
1. Haz click en **Configure** de nuevo. Mientras haya error(es) en rojo en la ventana de registro, deberás revisar tus parámetros y volver a ejecutarlo.
...
1. En el menú superior, haz click en **Build** y selecciona **Configuration Manager**.

    1. Establece **Active Solution Configuration** en **RelWithDebInfo**.

    1. Establece **Active Solution Platform** en **x64** y luego haz click en Close (la configuración se guarda automáticamente).

1. Haz click derecho en **ALL_BUILD** en el Solution Explorer de la barra lateral derecha y selecciona **Clean**.

1. Haz click derecho en **ALL_BUILD** y selecciona **Build**. (Ctrl + Shift + B)

    1. Si tu GUI no muestra el Solution Explorer, haz click en el menú Build y selecciona **Clean Solution**, y luego **Build**.
