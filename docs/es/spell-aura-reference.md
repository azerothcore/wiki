...
[`Volver a: Spell Effects Reference`](spell-effects-reference)

[`Volver a: spell_dbc`](spell_dbc)


### Esta página contiene la descripción del uso de EffectMiscValue y otros valores de Spell Aura.
### Contiene solo las Spell Auras que tienen un uso conocido de EffectMiscValue u otros valores no convencionales.

**La versión es: 3.3.5a**

# Nombres de Spell Aura

SPELL_AURA_MOD_POSSESS = 2
- BasePoints: (+Die Points) Hasta el nivel que puede ser encantado
...
- Amplitude: El tiempo en MS en que se producirá el trigger.
...
- EffectMiscValueA: ID de SpellShapeshiftForm.dbc

SPELL_AURA_EFFECT_IMMUNITY = 37
- EffectMiscValueA: ID de [Spell Effect](spell-effects-reference) al que volverse inmune.

SPELL_AURA_STATE_IMMUNITY = 38
- EffectMiscValueA: ID de Spell Auras
...
- EffectMiscValueA: Rune Type a convertir
- EffectMiscValueB: La nueva runa convertida

SPELL_AURA_MOD_MECHANIC_DAMAGE_TAKEN_PERCENT = 255
- EffectMiscValueA: [Spell Mechanic](#spell-mechanic)

SPELL_AURA_NO_REAGENT_USE = 256
- EffectMiscValueA: Una especie de tipo de reactivo.

SPELL_AURA_MOD_HOT_PCT = 259
- EffectMiscValueA: [School Mask](#school-mask)

SPELL_AURA_SCREEN_EFFECT = 260
- EffectMiscValueA: ID de screen ScreenEffect.dbc
...
- EffectMiscValueA: ID de screen OverrideSpellData.dbc

SPELL_AURA_PREVENT_REGENERATE_POWER = 294
- EffectMiscValueA: [Power Type](#power-type)

SPELL_AURA_SET_VEHICLE_ID = 296
- EffectMiscValueA: ID de Vehicle.dbc
...
- EffectMiscValueA: ID de AuraStateType (master/src/server/shared/SharedDefines.h)
