...
<a href="https://github.com/wowgaming/client-data/releases/" target="_blank">Full data (v14) - from 09/05/2022 to now</a> (RECOMMENDED - Used in the automatic downloader script in `/apps/`)
