...
<a href="https://github.com/wowgaming/client-data/releases/" target="_blank">Full data (v15) - from 21/06/2022 to now</a> (RECOMMENDED - Used in the automatic downloader script in `/apps/`)
